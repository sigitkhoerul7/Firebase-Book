...
public class MainActivity extends AppCompatActivity {
    public static final String AUTHOR_NAME = "com.example.geeksfarm.firebaseexample.authorname";
    public static final String AUTHOR_ID = "com.example.geeksfarm.firebaseexample.authorid";
    ...
    //a list to store all the author from firebase database
    List<Author> authors;
